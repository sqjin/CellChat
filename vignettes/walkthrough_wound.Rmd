...
---
title: "Walkthrough -- CellChat analysis of cell-cell communication in mouse skin wounds"
author: "Suoqin Jin"
...
```{r,message=FALSE,warning=FALSE}
data.dir <- '/Users/suoqinjin/Documents/CellChat/walkthrough'
dir.create(data.dir)
setwd(data.dir)
```
...
Here we show an example of TGFb signaling network. All the signaling pathways showing significant communications can be accessed by `cellchat@netP$pathways`.
...
```
Here is an example of non-canonical WNT signaling network visualized by circle plot.
```{r, fig.width=6,fig.height = 6, fig.wide = TRUE, fig.align = "center"}
netVisual_aggregate(cellchat, signaling = c("ncWNT"), layout = "circle", vertex.size = groupSize)
```

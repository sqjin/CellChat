...
#' @examples
#'
netVisual <- function(object, signaling, signaling.name = NULL, vertex.receiver = NULL, top = 1, color.use = NULL, from = NULL, to = NULL, bidirection = FALSE, remove.isolate = FALSE, vertex.size = 20,
                      layout = c("hierarchy","circle"), height = 5, thresh = 0.05, pt.title = 12, title.space = 6, vertex.label.cex = 0.8,
...
#' @return A network graph of the significant interactions
#' @export
netVisual_circle <-function(net, color.use = NULL, from = NULL, to = NULL, bidirection = FALSE, remove.isolate = FALSE, signaling.name = NULL, top = 1, weight.scale = FALSE,label.edge = FALSE,edge.curved=0.2,shape='circle',layout=in_circle(),vertex.size=20,margin=0.2,
